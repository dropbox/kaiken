...
import java.io.File
internal const val VERSION = "1.0.9-SNAPSHOT"
internal const val GROUP = "com.dropbox.kaiken"

@AutoService(KotlinGradleSubplugin::class)
@Suppress("unused")
class KaikenSubplugin : KotlinGradleSubplugin<AbstractCompile> {

    override fun isApplicable(
            project: Project,
            task: AbstractCompile
    ): Boolean = project.plugins.hasPlugin(KaikenPlugin::class.java)

    override fun getCompilerPluginId(): String = "com.dropbox.kaiken.processor"
    ...
    override fun apply(
        ...
        val srcGenDir = File(project.buildDir, "kaiken${File.separator}src-gen-${kotlinCompile.name}")
        ...
        val extension = project.extensions.findByType(KaikenExtension::class.java)
                ?: KaikenExtension()
