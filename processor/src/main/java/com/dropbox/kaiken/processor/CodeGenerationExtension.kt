...
import com.dropbox.kaiken.processor.anvil.CodeGenerator
import com.dropbox.kaiken.processor.anvil.PrivateCodeGenerator
...
internal class CodeGenerationExtension(
  ...
  override fun analysisCompleted(
    ...
    fun generateCode(files: Collection<KtFile>): Collection<CodeGenerator.GeneratedFile> =
      codeGenerators
          .flatMap {
  ...
  private fun Collection<CodeGenerator.GeneratedFile>.parse(psiManager: PsiManager): Collection<KtFile> =
